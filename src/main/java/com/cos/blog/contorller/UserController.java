...
public class UserController {
    ...
    public String kakaoCallback(String code){ // 데이터를 리턴해주는 컨트롤러 주소
        ...
        params.add("client_id","d6f38781580c15aa9995e87350867979");
        params.add("redirect_uri","http://localhost:8080/auth/kakao/callback");
        params.add("code",code);

        // HttpHeader와 HttpBody로 하나의 오브젝트에 담기
...
//        UUID garbagePassword = UUID.randomUUID(); UUID는 중복되지 않는 특정 값을 만들어내는 알고리즘
